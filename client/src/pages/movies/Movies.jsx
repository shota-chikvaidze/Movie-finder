  ...
  return (
    <section className="min-h-screen bg-gradient-to-br from-[#1a1d29] via-[#2f3236] to-[#1a1d29] py-8 px-4">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          <h1 className="text-white text-2xl sm:text-4xl font-bold mb-2">Discover Movies</h1>
          <p className="text-white/60 text-sm sm:text-lg">Find the perfect movie for your mood</p>
        </div>
