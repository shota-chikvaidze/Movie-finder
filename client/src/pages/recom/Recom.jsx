    ...
    <section className='min-h-screen  py-12 px-4 sm:px-6 lg:px-8'>
      <div className='max-w-7xl mx-auto'>
        ...
        <div className='mb-20'>
          ...
          {trendingLoading ? (
            <div className="min-h-20 flex justify-center items-center py-20">
          ...
          {!user ? (
            <div className="min-h-[50vh] flex items-center justify-center">
              <div className="flex flex-col items-center gap-5 text-center">
                <div>
                  <h2 className="text-white text-xl font-bold font-mono">Register to get recommendations</h2>
                  <p className="text-white/40 text-sm font-mono mt-2">Create an account to start getting recommendations of movies & series</p>
                </div>
